...
from multimodal.models.albef.bert_tokenizer import BertTokenizer
...
class ALBEF_VQA(nn.Module):
    ...
    def from_pretrained(cls):
        ...
        checkpoint = torch.hub.load_state_dict_from_url("https://storage.googleapis.com/sfr-pcl-data-research/ALBEF/vqa.pth")
        tokenizer = BertTokenizer.from_pretrained("bert-base-uncased")
        model = ALBEF_VQA(text_encoder="bert-base-uncased", tokenizer=tokenizer)
